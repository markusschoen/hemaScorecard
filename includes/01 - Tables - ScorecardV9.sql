...
(81, 'Symphony Ranking', 2, 0, '== Ranking ===\r\nIndicator Score\r\n1st Tiebreaker: Wins\r\n\r\n== Indicator Score ===\r\nBase Score: 3*Wins + 1*Ties\r\nBonus Score: Based on point difference\r\nDiff >=7: +3, >=5: +2, >=3: +1, else +0\r\nTotal Score = Base + Bonus', NULL, 'Symphony', '#Symphony', 'score', 'DESC', 'wins', 'DESC', 'pointsFor - pointsAgainst', 'DESC', 'pointsAgainst', 'ASC', 'Score', 'score', 'Wins', 'wins', 'Points Difference', 'pointsFor - pointsAgainst', 'Points Against', 'pointsAgainst', NULL, NULL);
-- --------------------------------------------------------
